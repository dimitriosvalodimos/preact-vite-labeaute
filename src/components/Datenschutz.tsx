  ...
  <div style={{ marginTop: "1rem", width: "80%" }}>
    <div style={{ padding: "1rem" }}>
      ...
      <p>
        ...
        Folgenden finden Sie Informationen zum Umgang mit Ihren Daten, die durch
        Ihre Nutzung unserer Website erfasst werden. Die Verarbeitung Ihrer
        Daten erfolgt entsprechend den gesetzlichen Regelungen zum Datenschutz.
      </p>
    </div>
    <div style={{ padding: "1rem" }}>
      <h2>Verantwortliche Stelle im Sinne des Datenschutzrechts</h2>
      <br />
      <p>LA-BEAUTÉ Gbr</p>
      <p>Wedeler Landstraße 49</p>
      <p>22559 Hamburg</p>
      <p>labeaute-rissen@t-online.de</p>
      <p>040 813271</p>
    </div>
    <div style={{ padding: "1rem" }}>
      ...
      <br />
      <p>
        Unsere Datenschutzerklärung soll für jedermann einfach und verständlich
        sein. In dieser Datenschutzerklärung werden in der Regel die offiziellen
        Begriffe der Datenschutzgrundverordnung (DSGVO) verwendet. Die
        offiziellen Begriffsbestimmungen werden in Art. 4 DSGVO erläutert.
      </p>
    </div>
    <div style={{ padding: "1rem" }}>
      <h2>Datenverarbeitung durch den Besuch unserer Website</h2>
      <br />
      <p>
      ...
      <ul>
        ...
        <li style={{ listStylePosition: "inside" }}>Zugriffsstatus</li>
        <li style={{ listStylePosition: "inside" }}>
        ...
        <li style={{ listStylePosition: "inside" }}>Übertragene Datenmenge</li>
      </ul>
      <br />
      <p>
        ...
        Nutzung unserer Website durch die Nutzer zu ermöglichen. Zudem dient die
        Logdatei der Auswertung der Systemsicherheit und -stabilität sowie
    ...
    <div style={{ padding: "1rem" }}>
      ...
      <ul>
        <li style={{ listStylePosition: "inside" }}>
          wenn wir in der Beschreibung der jeweiligen Datenverarbeitung explizit
        ...
        <li style={{ listStylePosition: "inside" }}>
          im Falle, dass für die Weitergabe nach Art. 6 Abs. 1 S. 1 lit. c DSGVO
          eine gesetzliche Verpflichtung besteht und
        </li>
        <li style={{ listStylePosition: "inside" }}>
      ...
      <p>
        ...
        Dienstleister, die wir sorgfältig ausgewählt und schriftlich beauftragt
        haben. Sie sind an unsere Weisungen gebunden und werden von uns
        regelmäßig kontrolliert. Mit welchen wir erforderlichenfalls
    ...
    <div style={{ padding: "1rem" }}>
      ...
      <br />
      <p>
        Im Folgenden finden Sie Informationen dazu, welche Betroffenenrechte das
      ...
      <br />
      <p>
        Das Recht, gemäß Art. 16 DSGVO unverzüglich die Berichtigung unrichtiger
      ...
      <p>
        ...
        des Bundeslandes unseres oben angegebenen Sitzes oder ggf. die Ihres
    ...
    <div style={{ padding: "1rem" }}>
      ...
      <p>
        ...
        verarbeitet werden, haben Sie gemäß Art. 21 DSGVO das Recht, Widerspruch
        gegen die Verarbeitung Ihrer personenbezogenen Daten einzulegen, soweit
        dies aus Gründe erfolgt, die sich aus Ihrer besonderen Situation
        ergeben. Soweit sich der Widerspruch gegen die Verarbeitung
        personenbezogener Daten zum Zwecke von Direktwerbung richtet, haben Sie
        ein generelles Widerspruchsrecht ohne das Erfordernis der Angabe einer
        besonderen Situation. Möchten Sie von Ihrem Widerrufs- oder
        Widerspruchsrecht Gebrauch machen, genügt eine E-Mail
        labeaute-rissen@t-online.de.
      </p>
    </div>
    <div style={{ padding: "1rem" }}>
      ...
      <p>
        ...
        unter Beachtung der geltenden Datenschutzvorschriften anzupassen bzw. zu
        aktualisieren. Auf diese Weise können wir sie den aktuellen rechtlichen
        Anforderungen anpassen und Änderungen unserer Leistungen
      ...
      <br />
      <p>Stand dieser Datenschutzerklärung: 25.11.2019</p>
    </div>
  </div>
);
